...
Write a python script/notebook to download all service requests records created **last week** (7 days) and has **HPD** as the responding agency, then store the data in a csv named `raw.csv` in a folder called `data`.
